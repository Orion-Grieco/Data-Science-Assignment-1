...
gender_class_survival = function(){
  ...
  pie(as.numeric(x_values),labels = percentages,main = "Survival Rate Percentages Based on Passenger Class and Gender",col = rainbow(length(x_values)),radius = 1)
...
age_survival = function(){
  ...
  age_csum = sum(age_group_1,age_group_2,age_group_3,age_group_4)
  library(ggplot2)
